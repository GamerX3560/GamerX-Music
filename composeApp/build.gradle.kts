...
android {
    ...
    namespace = "com.gamerx.music"
    compileSdk = 36

    signingConfigs {
        create("release") {
            storeFile = file("/home/gamerx/.android/debug.keystore")
    ...
    defaultConfig {
        applicationId = "com.gamerx.music"
        minSdk = 26
        targetSdk = 36
        versionCode =
