...
fun ReviewDialog(
    ...
    AlertDialog(
        ...
        confirmButton = {
            TextButton(onClick = {
                onDoneReview.invoke()
                uriHandler.openUri("https://github.com/GamerX3560/GamerX-Music")
            }) {
                Text(
        ...
        text = {
            Text(
                buildAnnotatedString {
                    ...
                    withLink(
                        LinkAnnotation.Url(
                            "https://github.com/GamerX3560/GamerX-Music",
                    ...
                    withLink(
                        LinkAnnotation.Url(
                            "https://buymeacoffee.com/GamerX",
                            TextLinkStyles(style = SpanStyle(textDecoration = TextDecoration.Underline, color = seed)),
                        ) {
                            onDoneReview.invoke()
                            onDismissRequest.invoke()
                            uriHandler.openUri("https://buymeacoffee.com/GamerX")
                        },
                    ) {
