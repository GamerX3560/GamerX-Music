...
val md_theme_dark_primary = Color(0xFF00FF41) // Neon Green
val md_theme_dark_onPrimary = Color(0xFF000000)
val md_theme_dark_primaryContainer = Color(0xFF003300)
val md_theme_dark_onPrimaryContainer = Color(0xFFCCFFCC)
val md_theme_dark_secondary = Color(0xFFFF0000) // Red
val md_theme_dark_onSecondary = Color(0xFFFFFFFF)
val md_theme_dark_secondaryContainer = Color(0xFF440000)
val md_theme_dark_onSecondaryContainer = Color(0xFFFFCCCC)
...
val md_theme_dark_background = Color(0xFF050505) // Almost Black
val md_theme_dark_onBackground = Color(0xFFE4E2E6)
val md_theme_dark_surface = Color(0xFF121212) // Dark Surface
...
val md_theme_dark_surfaceTint = Color(0xFF00FF41)
