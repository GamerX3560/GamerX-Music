...
class MusicWidget : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.gamerx.gamerx_music.ACTION_PLAY_PAUSE"
        const val ACTION_PREV = "com.gamerx.gamerx_music.ACTION_PREV"
        const val ACTION_NEXT = "com.gamerx.gamerx_music.ACTION_NEXT"
        const val ACTION_SHUFFLE = "com.gamerx.gamerx_music.ACTION_SHUFFLE"
        const val ACTION_LIKE = "com.gamerx.gamerx_music.ACTION_LIKE"
        const val ACTION_REPLAY = "com.gamerx.gamerx_music.ACTION_REPLAY"
        const val ACTION_STATE_CHANGED = "com.gamerx.gamerx_music.ACTION_STATE_CHANGED"
        const val ACTION_UPDATE_PROGRESS = "com.gamerx.gamerx_music.ACTION_UPDATE_PROGRESS"
