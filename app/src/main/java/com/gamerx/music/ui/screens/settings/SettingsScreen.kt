...
fun SettingsScreen(
    ...
    Column(
        ...
        Box(
            ...
            Image(
                painterResource(R.drawable.monochrome),
...
fun VersionCard(uriHandler: UriHandler) {
    ...
    ElevatedCard(
        ...
        onClick = { uriHandler.openUri("https://github.com/gamerx-Android/GamerX Music/releases/latest") }
    ) {
        Column(
            modifier = Modifier
...
fun UpdateCard(uriHandler: UriHandler) {
    ...
    if (showUpdateCard) {
        ...
        ElevatedCard(
            ...
            shape = RoundedCornerShape(38.dp),
            onClick = {
                uriHandler.openUri("https://github.com/gamerx-Android/GamerX Music/releases/latest")
            }
        ) {
            Column(
                modifier = Modifier
